...
public class YouTubeViewController extends FragmentPageBase {
	...
	private void getYoutubeInfoArray() {
		...
		ArrayList<YoutubeRowInfo> youtubeRowInfoListFromInitInfo = InitInfoStore.getInstance().getYoutubeRowInfoList();
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					InitInfoStore.getInstance().setYoutubeRowInfoList(youtubeRowInfoList);
