...
import com.renuar.DeepLinkController;
...
import com.renuar.json.stores.TaxonsStore;
...
public class FragmentRoot extends Fragment {
	...
	public void openChosenPromotionFragment(Bundle args) {
	...
	public void openFragmentFromActionLabel(String fragmentKey, Bundle args) {
		...
		if (pageParams != null) {
			...
			openChosenPromotionFragment(argsForPromotion);
		}
