...
public class OrderDetailsStore extends Store implements Serializable,
	...
	@SerializedName("available_payment_method")
	...
	public OrderDetailsStore(List<NameValuePair> postParams) {
		...
		postParams.add(new BasicNameValuePair(  "order[platform]",
				"Android"));
	}
	...
	protected void setStore(Store store) {
		...
		this.availablePaymentMethod = orderDetailsStore.availablePaymentMethod;
