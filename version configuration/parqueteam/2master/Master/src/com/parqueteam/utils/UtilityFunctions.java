...
import com.parqueteam.pagefragments.MximoFacebookShareDialog;
...
public class UtilityFunctions {
	...
	public static void setHighLightAnimation(final View view) {
		...
		Integer colorFrom = App.getApp().getResources().getColor(R.color.red);
		Integer colorTo = App.getApp().getResources().getColor(R.color.black);
