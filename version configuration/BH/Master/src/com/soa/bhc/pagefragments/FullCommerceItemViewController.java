...
import com.soa.bhc.json.helpers.ItemPageParams;
...
public class FullCommerceItemViewController extends FragmentPageBase implements
	...
	{
		RatingBar rb = (RatingBar) viewOfFragment.findViewById(R.id.com_iinfo_RatingBar);
		
		LayerDrawable stars = (LayerDrawable) rb.getProgressDrawable(); 
        stars.getDrawable(2).setColorFilter(Color.parseColor("#8acf39"), PorterDuff.Mode.SRC_ATOP);
	}
