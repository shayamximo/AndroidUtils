...
import com.soa.bhc.json.AppInfo;
import com.soa.bhc.json.stores.SaleStore;
import com.soa.bhc.json.stores.ShippingLocationStore;
...
public class App extends Application {
	...
	private void airPushInit() {
		...
		if (apid != null) {
			...
			try {
				String fpath = GlobalConstants.QA_FILE_PATH;
