...
import com.soa.bhc.CustomizedViews.ReclickableTabHost;
import com.soa.bhc.CustomizedViews.ReclickableTabHost.HomeTabClickedListener;
import com.soa.bhc.category.NavDrawerItem;
import com.soa.bhc.category.NavDrawerItemTabReplacement;
import com.soa.bhc.category.NavDrawerListAdapter;
import com.soa.bhc.category.NavDrawerListAdapterTabReplacement;
import com.soa.bhc.json.helpers.ConfigurableTabInfo;
import com.soa.bhc.json.helpers.TabInfo;
...
import com.soa.bhc.pagefragments.DialogExitFragment;
import com.soa.bhc.pagefragments.FragmentRoot;
import com.soa.bhc.pagefragments.MximoDialog.IOnUserChooseOption;
import com.soa.bhc.userselection.UserSelectionStore.IOnAmountOfItemsInListChange;
import com.soa.bhc.userselection.UserSelectionStore.IonItemsFinishedLoadingFromDataBase;
import com.soa.bhc.utils.ConfigurationFile;
import com.soa.bhc.utils.FontsOverride;
import com.soa.bhc.utils.MximoFlurryAgent;
import com.soa.bhc.utils.SharedPreferencesController;
...
public class MainActivity extends FragmentActivity {
	...
	private void addTab(String tabName, String label, String tag,
		...
		if (label.equals("Home") && dlc != null && dlc.isRelevant()) {
